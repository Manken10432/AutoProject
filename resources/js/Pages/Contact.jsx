                        ...
                        <div style={{ gridColumn: 'span 2' }}>
                            <ScrollReveal delay={1}>
                                <div style={{ background: '#141414', border: '1px solid #1c1c1c', padding: '2.25rem' }}>
                                    ...
                                    {errors.rate_limit && (
                                        <div style={{ background: 'rgba(195,0,47,0.08)', border: '1px solid rgba(195,0,47,0.25)', color: '#ff4d6a', padding: '0.875rem 1rem', marginBottom: '1.5rem', display: 'flex', gap: '0.625rem', alignItems: 'center', fontFamily: "'DM Sans', sans-serif", fontSize: '0.875rem' }}>
                                            <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path d="M12 9v2m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" /></svg>
                                            {errors.rate_limit}
                                        </div>
                                    )}
