...
<head>
    ...
    <style>
        ...
        .header-logo span { color: #C3002F; }
        .badge { display: inline-block; background: #C3002F; color: #fff; font-size: 11px; font-weight: 700; padding: 3px 10px; text-transform: uppercase; letter-spacing: 1px; margin-top: 8px; }
        .body { padding: 32px; }
        ...
        .field-value { font-size: 15px; color: #111; background: #f8f8f8; padding: 10px 14px; border-left: 3px solid #C3002F; }
        ...
        .btn { display: inline-block; background: #C3002F; color: #fff; text-decoration: none; padding: 12px 24px; font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; margin-top: 20px; }
    </style>
</head>
<body>
    <div class="wrapper">
